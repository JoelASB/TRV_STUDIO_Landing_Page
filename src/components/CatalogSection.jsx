        ...
        <div className="flex flex-wrap gap-3 mb-10">
          {filters.map((tag) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${activeFilter === tag ? 'bg-text-primary text-primary' : 'bg-surface text-text-muted hover:bg-text-primary/10 hover:text-text-primary'}`}
            >
              {tag}
            </button>
          ))}
